...
func CheckAssignableTo(guard dgo.RecursionGuard, t interface{}, other dgo.Value) bool {
...
func TypeFromReflected(vt reflect.Type) dgo.Value {
...
var primitivePTypes = map[reflect.Kind]dgo.Value{
...
var TypeString func(dgo.Value) string
